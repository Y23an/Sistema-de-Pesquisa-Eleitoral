...
# router = APIRouter(prefix="/alternativa", tags=["Alternativas"])
...
# def criar_alternativa(alternativa: CriarAlternativaSchema, service: AlternativaService = Depends[get_alternativa_service]):
#     return service.criar_alternativa(alternativa)

# @router.get("/", response_model=list[AlternativaSchema])
# def listar_alternativas(texto: Optional[str] = None,
...
# def obter_alternativa_por_id(alternativa_id: int, service: AlternativaService = Depends[get_alternativa_service]):
#     return service.obter_alternativa_por_id(alternativa_id)

# @router.put("/{alternativa_id}", response_model=AlternativaSchema)
# def atualizar_alternativa(alternativa_id: int, alternativa: AtualizarAlternativaSchema, service : AlternativaService = Depends[get_alternativa_service]):
#     return service.atualizar_alternativa(alternativa_id, alternativa)

# @router.patch("/{alternativa_id}", response_model=AlternativaSchema)
# def desativar_alternativa(alternativa_id: int, service : AlternativaService = Depends[get_alternativa_service]):
#     return service.desativar_alternativa(alternativa_id)
